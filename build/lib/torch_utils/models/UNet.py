...
class UNet(Module):
    def __init__(self, n_classed=2, in_features=1, edge_opt=False):
        super(UNet, self).__init__()
        self.pool = MaxPool2d(2)
        self.en_block1 = _ConvBlock(in_features, 64, edge_opt)
        self.en_block2 = _ConvBlock(64, 128, edge_opt)
        self.en_block3 = _ConvBlock(128, 256, edge_opt)
        self.en_block4 = _ConvBlock(256, 512, edge_opt)
        self.en_block5 = _ConvBlock(512, 1024, edge_opt)
        ...
        self.de_block1 = _ConvBlock(1024, 512, edge_opt)
        self.de_block2 = _ConvBlock(512, 256, edge_opt)
        self.de_block3 = _ConvBlock(256, 128, edge_opt)
        self.de_block4 = _ConvBlock(128, 64, edge_opt)
